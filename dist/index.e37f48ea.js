...
showRecipe(); */ const renderSpinner = (parentEl)=>{
    const spinner = `
    <div class="spinner">
      <svg>
...
module.exports = require("2bf29b0af8b25399").getBundleURL("hWUTQ") + "icons.dfd7a6db.svg" + "?" + Date.now();

},{"2bf29b0af8b25399":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["d8XZh","aenu9"], "aenu9", "parcelRequire8048")
